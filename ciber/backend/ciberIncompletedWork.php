<?php
	...
	if (isset($_SESSION['item'])) {
		...
		$query = $db->connect()->prepare("UPDATE ciber_item SET item_status = 'En proceso' WHERE id = '$itemId'");
		...
		$value= "El empleado ".$_SESSION['name'].", con id = ".$_SESSION['id'].", ha registrado que el artículo sigue en reparación";
