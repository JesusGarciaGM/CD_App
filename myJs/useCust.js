$(document).ready(function(){
	...
	$(document).on('click','#buttonCan',function(){
		...
		$('#rou').prop('disabled',false);
		$('#tel').prop('disabled',false);
		$('#con').prop('disabled',false);
		$('#ubi').prop('disabled',false);
		$('#fecP').prop('disabled',false);
	...
	$(document).on('click','.cust-item',function(){
		...
		$.post('../backend/cust-single.php',{id},function(response){
			...
			$('#rou').prop('disabled',true);
			$('#tel').prop('disabled',true);
			$('#con').prop('disabled',true);
			$('#ubi').prop('disabled',true);
			$('#fecP').prop('disabled',true);	
		});
	});
	...
	$('#cust-form').submit(function(e){
		...
		$('#buttonCan').hide();
		$.post('../backend/cust-add.php',postData,function(response){
			$('#cust-form').trigger('reset');
			location.reload();
		});
		e.preventDefault();
